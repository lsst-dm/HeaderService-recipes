export LSSTTS_SALOBJ_VERSION=6.7.0
export LSSTTS_XML_VERSION=10.1.0
export LSSTTS_SALIDL_VERSION=3.5.0
export LSSTTS_DDSCONFIG_VERSION=v0.9.0
export HEADERSERVICE_VERSION=2.9.2
export LSSTTS_DEPLOY_VERSION=c0023
