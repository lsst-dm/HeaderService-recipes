export LSSTTS_SALOBJ_VERSION=6.1.0
export LSSTTS_XML_VERSION=7.0.0
export LSSTTS_SALIDL_VERSION=2.1.0
export LSSTTS_DDSCONFIG_VERSION=v0.2.0
export HEADERSERVICE_VERSION=2.5.4
export LSSTTS_DEPLOY_VERSION=c0016
